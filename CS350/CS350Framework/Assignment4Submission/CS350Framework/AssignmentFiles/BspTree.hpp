...
Purpose: This file contains the interface for a binary spatial partition tree.
...
private:
  ...
  void Draw(BSPNode* node, int depth, int level, const Vector4& color, int bitMask);
};
